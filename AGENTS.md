...
│       ├── lazy-access-token/index.js / .d.ts      # createLazyAccessToken — on-demand cached token
│       └── renewable-access-token/index.js / .d.ts # createRenewableAccessToken — timer-renewed token
├── tests/
